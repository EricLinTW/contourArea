...
//            //msg_if_image.data = x;
//        }
//        Mat src_HSV;//20170420
//        Mat hsv_threshold;//20170420
//        Mat src_add_mask;//20170420
//        cap.read(src);// src;
//        src.copyTo(src_copy);
//        //src.copyTo(src_HSV); //20170420  *************src_HSV 的來源(記憶體位置)和src一樣
//        src_HSV = src.clone(); ////20170420*************** 完整複製一套src出來 ,output的來源(記憶體位置)和不同
...
//        //ROS_INFO_STREAM("Point (" << msg_xy_angle.x << ", " << msg_xy_angle.y << ")\tangle " << msg_xy_angle.z << "\t Area " << msg_area.data); //20170420
//        imshow("src", src);
